              ...
              <form action="/produk/{{$produk->id}}/update" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row mb-4">
                  ...
                  <select class="form-control col-sm-12 col-md-7" name="kategori">
                    <option value="Magazine" @if($produk->kategori == 'Magazine') selected @endif class="form-control col-sm-12 col-md-7">Magazine</option>
                    <option value="Premium" @if($produk->kategori == 'Premium') selected @endif class="form-control col-sm-12 col-md-7">Premium</option>
                    <option value="Luxury" @if($produk->kategori == 'Luxury') selected @endif class="form-control col-sm-12 col-md-7">Luxury</option>
                  </select>
                </div>
                ...
                <div class="form-group row mb-4">
                  ...
                  <div class="col-sm-12 col-md-7">
                    <input type="text" name="ukuran" class="form-control" value="{{$produk->ukuran}}">
                  </div>
                </div>
                ...
                <div class="form-group row mb-4">
                  ...
                  <div class="col-sm-12 col-md-7">
                    <input type="text" name="in_currency" class="form-control" value="{{$produk->in_currency}}">
                  </div>
                </div>
                ...
                <div class="form-group row mb-4">
                  ...
                  <div class="col-sm-12 col-md-7">
                    <input type="file" name="imageurl" class="form-control" value="{{$produk->imageurl}}">
                  </div>
                </div>
