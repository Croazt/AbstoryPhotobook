...
@section('content')
  ...
  <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-4 py-12">
        ...
        <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
          ...
          <span class="text-center w-1/5 font-semibold text-sm">$600.00</span>
        </div>

        <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
          <span class="w-4/5"></span>
          <span class="text-center w-1/5 text-sm">
            <button class="bg-gray-500 font-semibold hover:bg-gray-600 py-3 text-sm w-full rounded-md text-white uppercase ">Checkout</button>
          </span>
        </div>
        <div class="flex items-center hover:bg-gray-100 -mx-8 px-6 py-5">
          <span class="w-4/5"></span>
          <span class="text-center w-1/5 text-sm">
            <button class="bg-gray-500 font-semibold hover:bg-gray-600 py-3 text-sm w-full rounded-md text-white uppercase ">Continue Shopping</button>
          </span>
        </div>
